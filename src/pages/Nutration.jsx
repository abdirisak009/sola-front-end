...
import katogonic from '../assets/images/katogonic.jpg'
import plantbaseddiet  from '../assets/images/plantbaseddiet.jpg'
import planbased  from '../assets/images/planbased.jpg'
import pleodiet  from '../assets/images/pleodiet.jpg'
import intermmitentfasting  from '../assets/images/intermmitentfasting.jpg'
import Dashdiet  from '../assets/images/Dashdiet.jpg'
...
import fatplantbaseddiets from '../assets/images/plantbaseddiet.jpg'
...
const Nutrition = () => {
  ...
  <Header />
   ...
   <button className='bg-white rounded-full text-[#44B75E] px-4 py-2 mt-4 font-[Roboto] cursor-pointer hover:bg-gray-200'>Explore Diet</button>
   </div>
...
<img className='w-full rounded-lg' src={mediterranean} alt="" />
  ...
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Heart-Health</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Anti-inflammontor</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Sustainable</a>
  </div>
</div>
{/* img 2 */}
<div className="img2">
<img className='w-full rounded-lg' src={katogonic} alt="" />
  ...
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Weigh lose</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Blood suger control</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>High Fat</a>
  </div>
</div>
{/* img 3 */}
...
<img className='w-full rounded-lg' src={planbased} alt="" />
  ...
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Eco-Friendly</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>High Fiber</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Netrien-Rich</a>
  </div>
</div>
...
<img className='w-full rounded-lg mt-20' src={pleodiet} alt="" />
   ...
   <div className='flex gap-4 font-semi-bold my-6'>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Whole foods</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Grain-free</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Low suger</a>
  </div>
</div>
...
<img className='w-full rounded-lg mt-20' src={intermmitentfasting} alt="" />
   ...
   <div className='flex gap-4 font-semi-bold my-6'>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>metabolic</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Flexible</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Autophagy</a>
  </div>
</div>
...
<img className='w-full rounded-lg mt-20' src={Dashdiet} alt="" />
   ...
   <div className='flex gap-4 font-semi-bold my-6'>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Blood presure</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200'>Low sodium</a>
  <a href="#" className='bg-[#d8ede2] px-2 py-1 rounded-full hover:bg-gray-200 '>Heart-Health</a>
  </div>
</div>
