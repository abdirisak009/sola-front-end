...
const LifestyleHero = () => {
  return (
    <div className='bg-[#22c55e] py-20 flex flex-col items-center space-y-7'>
            <div>
                <h1 className='text-5xl font-bold tracking-wide text-[#fff] text-center max-w-3xl mx-auto'>Cultivate a Healthy Lifestyle & Mindset </h1>
            </div>
            <div>
