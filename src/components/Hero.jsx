  ...
  return (
    <>
     <section className="bg-cover bg-center h-screen"
        style={{ backgroundImage: `url(${hero})` }}>
          <h1 className='text-center text-5xl leading-16 font-bold py-10'>Nutrition tracking <br /> for <span className='bg-[#FAA432] text-white px-3'>real life</span></h1>
    </section>
      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-26 ml-26">
          ...
          <div className=" ">
            ...
            <h3 className="text-xl font-bold mb-2 text-left">Set Your Goals</h3>
          ...
          <div className="flex flex-col ">
            ...
            <h3 className="text-xl font-bold mb-2 text-left">Track Your Food</h3>
            <p className="text-sm  text-left">
    ...
    <div className="font-sans">
      ...
      <section className="text-center py-12 px-6">
        <h3 className="text-3xl font-bold mb-3">Start Your Health Journey Today</h3>
        <p className="text-gray-600 max-w-xl mx-auto mb-6">
          Join thousands of users who have transformed their lives with NutriTracker. 
          Our easy-to-use app helps you stay on track with your nutrition goals.
        </p>
